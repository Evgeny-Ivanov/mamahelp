...
btnNeedHelp.click(function () {
    console.log('element to delete: ' + '#' + this.id)
        ...
        $.each(key, function (k) {
            ...
            if (nameOfField === 'days') {
                ...
                $.each(day, function (d) {
                    ...
                    // $(":checkbox[value=" + day[d] + "]").prop("checked", "true");
                    console.log($("#need-days-" + helpType + " :checkbox[value=" + day[d] + "]"));
                    console.log($(":checkbox[value=" + day[d] + "]"));
                });
